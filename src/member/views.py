...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            SubClassification.objects.create(name="breakfast", classification=c1, member=member)
            SubClassification.objects.create(name="salary", classification=c8, member=member)
